...
dies_ok { Test2::Log::Log4perl->_matches("foo", {}) } "hash";
dies_ok { Test2::Log::Log4perl->_matches("foo", bless({}, "bar"))} "object";
...
ok(Test2::Log::Log4perl->_matches("foo", bless({}, "Wibble")), "foo foo object");
ok(!Test2::Log::Log4perl->_matches("bar", bless({}, "Wibble")), "bar foo object ");
